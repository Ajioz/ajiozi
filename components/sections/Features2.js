          ...
          <div className="row">
              ...
              <div className="inner-box">
                <div className="image-box">
                  <figure className="image">
                    <img src="images/resource/feature-1.jpg" alt="Image" />
                  </figure>
                ...
                <div className="content-box">
                  ...
                  <div className="text">
                    We have to a tendency to believe the idea
                  </div>
            ...
            >
              <div className="inner-box">
                <div className="image-box">
                  <figure className="image">
                    <img src="images/resource/feature-2.jpg" alt="Image" />
                  </figure>
            ...
            >
              <div className="inner-box">
                <div className="image-box">
                  <figure className="image">
                    <img src="images/resource/feature-3.jpg" alt="Image" />
                  </figure>
