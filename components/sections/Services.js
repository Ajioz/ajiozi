            ...
            <div className="service-info-block col-lg-6 wow fadeInUp">
              <div className="inner-box">
                <div className="sec-title text-gradient mb-5 mb-lg-0">
                  ...
                  <div className="text">There are many variations of passages of available but majority have suffered alteration in some form</div>
                </div>
              </div>
            </div>
            ...
            <div className="service-block-three col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="600ms">
              <div className="inner-box">
                <div className="content-box">
                  ...
                  <h4 className="title"><Link href="page-service-details">Apps <br/>Development</Link></h4>
                </div>
              </div>
            </div>
