            ...
            <header className={`main-header header-style-one ${isSearch ? "moblie-search-active" : ""}`}>
                ...
                <div className="inner-container">
                    ...
                    <ul className="list-style-one">
                        ...
                        <li><i className="fa fa-envelope"></i> <Link href="#" className="mailto:needhelp@company.com">needhelp@company.com</Link></li>
                    </ul>
                    </div>
                ...
                <div className="main-box">
                    ...
                    <div className="logo"><Link href="/"><img src="images/logo.png" alt="" title="Instec"/></Link></div>
                    </div>
                    ...
                    <Link href="tel:+92(8800)9806" className="info-btn"> <i className="icon fa fa-comments"></i> <small>Call Anytime</small> <strong>+ 88 ( 9800 ) 6802</strong> </Link> <span className="divider"></span> 
